...
builder.Services.AddSwaggerGen(c =>
{
    ...
    c.AddServer(new() { Url = "https://tarefando.onrender.com", Description = "Development Server" });
    c.AddServer(new() { Url = "https://tarefando.onrender.com", Description = "Production Server" });
});
